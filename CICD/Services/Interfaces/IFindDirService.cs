...
public interface IFindDirService
{
    ...
    /// until a directory with a name that matches the given <paramref name="dirNameToFind"/>.
    /// </summary>
    /// <param name="startPath">The directory path to start the search from.</param>
